...
<title>User Page</title>
 <link href="images/shailey.css" rel="stylesheet" type="text/css">
<style type="text/css">
.userwelcome
{
...
#menu3 li a:hover {
		...
		.userta
	{
		...
		<script type="text/javascript" src="images/lib/jquery-1.3.2.min.js"></script>
		<script type="text/javascript" src="images/lib/jquery.tools.js"></script>
    	<script type="text/javascript" src="images/lib/jquery.custom.js"></script>
		
<!-- Pirobox setup and styles -->

<script type="text/javascript" src="images/lib/pirobox.js"></script>
...
<link href="images/imagess/style.css" rel="stylesheet" type="text/css" /> 

<!-- Pirobox setup and styles end-->

        <link href="images/styles.css" rel="stylesheet" type="text/css" media="screen" />
...
<tr><td class="userelcome"><%=dname%> </td><td>|</td><td><a href="images/index.html" style="color:#000">Logout</a></td>
...
<tr><td><a href="#" target="ifram"><img src="images/new/pserviceurcar.png" width="195" height="61"/></a></td></tr>
<tr><td><a href="images/services/sales.html" target="ifram"><img src="images/new/ptobuyold.png" width="195" height="61"/></a></td></tr>
<tr><td><a href="images/services/insurencerenew.html" target="ifram"><img src="images/new/homebtmo.png" width="195" height="61"/></a></td></tr>
<tr><td><a href="#" target="ifram"><img src="images/new/profile.jpg" width="195" height="55"/></a></td></tr>
<tr><td><a href="#" target="ifram"><img src="images/new/status.jpg" width="195" height="55"/></a></td></tr>
<tr><td>
<form action="images/barchart.jsp" method="post">
 <input type="text" name="vn" value="<%=vehicle%>" style="display:none" />
<img src="images/new/chart.jpg" width="195" height="55"/>

</form></td></tr>

<tr><td><a href="#" target="ifram"><img src="images/new/workshop.gif" width="200" height="33"/></a></td></tr>
<tr><td><a href="images/services/sales.html" target="ifram"><img src="images/new/query.gif" width="200" height="33"/></a></td></tr>
<tr><td><a href="images/services/insurencerenew.html" target="ifram"><img src="images/new/feedback.gif" width="200" height="33"/></a></td></tr>
...
<tr><td><img src="images/new/myAdvertsieBanner.jpg" width="590px" height="156" /></td></tr>
</table>
...
<table align="center" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr valign="top">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="210">
        <tbody><tr>
          <td><img src="images/book-new-vehicle_files/spiral.jpg" height="19" width="200" align="right"></td>
        </tr>
        <tr>
          <td background="images/book-new-vehicle_files/why-bg1.gif"><img src="images/book-new-vehicle_files/why-us.gif" height="28" width="210"></td>
        </tr>
        <tr>
          <td  class="margin" align="left" background="images/book-new-vehicle_files/why-bg1.gif" > <p><img src="images/book-new-vehicle_files/why-us-ico.jpg" align="left" height="16" width="37">
          <br>We
...
Our facilities are unmatchable &amp; state of art. We specialize in: </p>
            ...
            <div class="call"><img src="images/book-new-vehicle_files/helpdesk.gif" border="0" height="17" width="87"><br>
    Let us serve you better...</div>
            <br>
    </td>
        </tr>
        <tr>
          <td background="images/book-new-vehicle_files/why-bg1.gif"><img src="images/book-new-vehicle_files/why-btm.gif" height="13" width="210"></td>
        </tr>
      </tbody></table>
...
Get FREE 4th Service</font>
		...
		<ul type="none">
			...
			<li><a href="#5" title="Link 5">Tyre fitting</a></li>	
                        ...
                        <div class="foot_col3">
                            <h3>New Arrivels</h3>
                            <a href="#"><img src="images/imagess/hero_honda_passion_pro_bike.jpg" alt="" width="200px" height="120px" title="" style="padding-bottom: 10px;"/></a>
                        ...
                        <div class="foot_col4">
                            ...
                            <br />
                            <br />
	<p class="foot-navi-link "><a class="a2a_dd" href="http://www.addtoany.com/share_save#url=www.yamaha-motor-india.com&amp;title=Service%20%7C%20India%20Yamaha%20Motor%20Pvt.%20Ltd.&amp;description="><img src="images/index_files/share_save_120_16.gif" alt="Share/Save/Bookmark" border="0" height="18" width="120"></a><script type="text/javascript">a2a_linkname=document.title;a2a_linkurl="www.yamaha-motor-india.com";</script><script type="text/javascript" src="images/index_files/page.js"></script>
    </p>
	</div>
                        </div>
